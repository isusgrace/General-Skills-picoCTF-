...
เนื้อหาที่อยู่ในไฟล์จะเป็นดังภาพที่ 1 ตัว Flag ถูกเข้ารหัสด้วย Base64 อยู่ ฉันมี 2 วิธีที่ที่จะใช้ในการถอดรหัส คือ ใช้ CyberChef กับ Kali Linux เลือกใช้วิธีใดวิธีหนึ่ง
