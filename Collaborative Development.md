...
```
คำสั่ง git checkout เป็นคำสั่งที่ใช้ในการ เปลี่ยนเวอร์ชันหรือสถานะการทำงาน ภายใน Git Repository ของเรา หน้าที่หลักของมันคือการย้ายตัวชี้ HEAD ไปยังตำแหน่งที่ระบุ ซึ่งทำให้คุณสามารถทำงานกับ Branch, Commit, หรือ Tag ที่แตกต่างกันได้
